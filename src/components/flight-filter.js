...
function FlightFilter() {
    ...
    const handleSubmit = (event) => {
        ...
        const departure = event.target.elements.formDeparture.value;
        const destination = event.target.elements.formDestination.value;
        const departureDate = event.target.elements.formDepartureDate.value;
        const returnDate = event.target.elements.formReturnDate.value;
        const passengers = event.target.elements.formPassengers.value;
    }
        return (
            <Form>
                <Row>
